    ...
    def on_status(self, status):
        ...
        if status.coordinates:
            if self.num_tweets < stream_tweets_limit:
                id = m.insert_one_document(collections['twitter_sentiments'], {"text": status.text, "loc": {"type": "Point", "coordinates": status.coordinates['coordinates']}})
